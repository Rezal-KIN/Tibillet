...
from BaseBillet.views_balance_total import balance_total, balance_tokens_rows, refund_local_form, refund_local_success, connexion_with_names, qr_card_landing
...
urlpatterns = [
    ...
    path('qr/<str:pk>/', qr_card_landing, name='qr_card_landing'),
