...
class ScanQrCode(viewsets.ViewSet):  # /qr
    ...
    def link(self, request):
        ...
        # Le mail est envoyé
        email = validator.validated_data['email']
        # Après confirmation email, l'utilisateur revient sur la page QR de sa carte
        _qr_next = signing.dumps(f"/qr/{validator.validated_data['qrcode_uuid']}/")
        user: TibilletUser = get_or_create_user(email, force_mail=True, next_url=_qr_next)
