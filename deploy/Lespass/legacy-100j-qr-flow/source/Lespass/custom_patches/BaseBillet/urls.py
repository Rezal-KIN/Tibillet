...
from BaseBillet.views_balance_total import balance_total, balance_tokens_rows, refund_local_form, refund_local_success, connexion_with_names, qr_card_landing, qr_card_link
...
urlpatterns = [
    path('api/discovery/claim/', ClaimPinView.as_view(), name='discovery-claim'),
    ...
    path('qr/link/', qr_card_link, name='qr_card_link'),   # doit être avant le router
    path('qr/<uuid:pk>/', qr_card_landing, name='qr_card_landing'),
    path('connexion_with_names/', connexion_with_names, name='connexion_with_names'),
